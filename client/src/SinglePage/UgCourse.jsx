...
import { Link } from "react-router-dom";
import Sdata1 from "../components/Data/SData";
...
const UgCourse = () => {
  const [currentPage, setCurrentPage] = useState('exploreprograms');

  const [specializations, setSpecializations] = useState(Sdata1);
  ...
  // useEffect(() => {
  //   let item = Sdata1.find((item) => item.id === parseInt(id));
  //   if (item) {
  //     setItem(item);
  //   }
  // }, [id]);
  ...
  const { id } = useParams();
  const item = Sdata1.bachelors.find(item => item.id.toString() === id);
  ...
  const onSpecializationClick = (specialization) => {
              ...
              >
                ...
                <div className="signup-form-wrapper">
                  ...
                  {/* <label> */}
                    ...
                    {/* <select className="form-control  txt input-border"
                      name="course"
                      onChange={handleInput}
            ...
            <div className="row">
              <div className="course-detalis-wrapper ">
                <div className="course-heading">
                  <h1 className="">{item.coursename}</h1>
                </div>
                <div className="coursedetails-container">
                  <div className="course-images">
                    <img src={item.coursepageimg} alt="course img" />
                  </div>
                  <div className="course-description">

                    <div className="">
                      <h2 className="course-leranm-tittle">{item.courseTitle}</h2>
                    </div>
                    <p>{item.courseDesc}</p>
                  </div>
                </div>
                <div className="course-detelis-meta">
                  <div className="course-Enroll border-line-meta">
                    <p>{item.univers}</p>
                    <span>{item.universCount}</span>
                  </div>
                  <div className="course-update border-line-meta">
                    <p>{item.duration}</p>
                    <span>{item.durationYear}</span>
                  </div>
                  <div className="course-category">
                    <p>{item.eligibility}</p>
                    <span>{item.qualif}</span>
                  </div>
                </div>
                <div className="course-learn">
                  <div className="">
                    <h2 className="">{item.componentsTitle}</h2>
                  </div>
                  <p className="course-components">
                    <b>{item.questioncontent1}</b> {item.answercontent1}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent2}</b> {item.answercontent2}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent3}</b> {item.answercontent3}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent4}</b> {item.answercontent4}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent5}</b> {item.answercontent5}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent6}</b> {item.answercontent6}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent7}</b> {item.answercontent7}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent8}</b> {item.answercontent8}
                  </p>
                  <p className="course-components">
                    <b>{item.questioncontent9}</b> {item.answercontent9}
                  </p>
                  {/* <Accordion /> */}
                </div>
                <div className="course-requirements">
                  <h2 className="">{item.enlightenTitle}</h2>
                  <p>{item.enlightendesc}</p>
                  <div className=""></div>
                </div>
                <div className="course-requirements">
                  ...
                  <ul className="specialization-list">
                    {item.specializations.map((specializationItem) => (
                      <Link to={`/Specialization/${id}`} >
                        <li key={specializationItem.id} item = {specializationItem}>
                          {specializationItem.name}
                        </li>
                      </Link>
                    ))}
                  </ul>
                  {/* <SpecializationPage specialization={selectedSpecialization} /> */}
                </div>
                <div className="course-requirements">
                  <h2 className="course-leranm-tittle">
                    {item.scopeandcareerProspects}
                  </h2>
                  <div>
                    <li>
                      {item.scopeandcareer1}
                    </li>
                    <li>

                      {item.scopeandcareer2}
                    </li>
                    <li>

                      {item.scopeandcareer3}
                    </li>
                    <li>

                      {item.scopeandcareer4}
                    </li>
                    <li>

                      {item.scopeandcareer5}
                    </li>
                    <li>

                      {item.scopeandcareer6}
                    </li>
                    <li>

                      {item.scopeandcareer7}
                    </li>
                    <li>

                      {item.scopeandcareer8}
                    </li>
                    <li>

                      {item.scopeandcareer9}
                    </li>
                    <li>

                      {item.scopeandcareer10}
                    </li>
                    <li>

                      {item.scopeandcareer11}
                    </li>
                  </div>
                </div>

                <div className="course-requirements-child">
                  <h4>{item.growthandcareer}</h4>

                  <div>
                    <p className="">
                      <b>{item.growthandcareertitle1}</b>{" "}
                      {item.growthandcareerdesc1}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle2}</b>{" "}
                      {item.growthandcareerdesc2}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle3}</b>{" "}
                      {item.growthandcareerdesc3}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle4}</b>{" "}
                      {item.growthandcareerdesc4}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle5}</b>{" "}
                      {item.growthandcareerdesc5}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle6}</b>{" "}
                      {item.growthandcareerdesc6}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle7}</b>{" "}
                      {item.growthandcareerdesc7}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle8}</b>{" "}
                      {item.growthandcareerdesc8}
                    </p>
                    <p className="">
                      <b>{item.growthandcareertitle9}</b>{" "}
                      {item.growthandcareerdesc9}
                    </p>
                    <p className=""> {item.growthandcareerdesc10}</p>
                  </div>
                </div>
                <div className="course-requirements">
                  <h2 className="course-leranm-tittle">{item.whyonline}</h2>
                  <div>
                    <li className="why-online">{item.whyonline1}</li>
                    <li className="why-online">{item.whyonline2}</li>
                    <li className="why-online">{item.whyonline3}</li>
                    <li className="why-online">{item.whyonline4}</li>
                    <li className="why-online">{item.whyonline5}</li>
                    <li className="why-online">{item.whyonline6}</li>
                ...
                <div className="course-requirements">
                  ...
                  <img src={item.admissionprocedure} alt="Why Course" />
                </div>

                <div className="course-requirements">
                  <h2 className="course-leranm-tittle">{item.benefits}</h2>

                  <div>
                    <li>
                      <b>{item.benefitstitle1}</b>
                      {item.benefits1}
                    </li>
                    <li>
                      <b>{item.benefitstitle2}</b>
                      {item.benefits2}
                    </li>
                    <li>
                      <b>{item.benefitstitle3}</b>
                      {item.benefits3}
                    </li>
                    <li>
                      <b>{item.benefitstitle4}</b>
                      {item.benefits4}
                    </li>
                  </div>
                </div>
