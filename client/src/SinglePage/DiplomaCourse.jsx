...
import Sdata3 from "../components/Data/SData3";
...
const DiplomaCourse = () => {
  ...
  useEffect(() => {
    let item3 = Sdata3.find((item3) => item3.id === parseInt(id));
    if (item3) {
      setItem3(item3);
    }
  }, [id]);
            ...
            <div className="row">
              <div className="course-detalis-wrapper ">
                <div className="course-heading ">
                  <h1 className="courses-title">{item3.coursename}</h1>
                </div>
                <div className="coursedetails-container">
                  <div className="course-images">
                    <img src={item3.coursepageimg} alt="course img" />
                  </div>
                  <div className="course-description">

                    <div className="">
                      <h2 className="course-leranm-tittle">{item3.courseTitle}</h2>
                    </div>
                    <p>{item3.courseDesc}</p>
                  </div>
                </div>
                <div className="course-detelis-meta">
                  <div className="course-Enroll border-line-meta">
                    <p>{item3.univers}</p>
                    <span>{item3.universCount}</span>
                  </div>
                  <div className="course-update border-line-meta">
                    <p>{item3.duration}</p>
                    <span>{item3.durationYear}</span>
                  </div>
                  <div className="course-category">
                    <p>{item3.eligibility}</p>
                    <span>{item3.qualif}</span>
                  </div>
                </div>
                ...
                <div className="course-learn">
                  <div className="">
                    <h2 className="course-leranm-tittle">
                      {item3.componentsTitle}
                    </h2>
                  </div>
                  <p className="course-components">
                    <b>{item3.questioncontent1}</b> {item3.answercontent1}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent2}</b> {item3.answercontent2}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent3}</b> {item3.answercontent3}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent4}</b> {item3.answercontent4}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent5}</b> {item3.answercontent5}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent6}</b> {item3.answercontent6}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent7}</b> {item3.answercontent7}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent8}</b> {item3.answercontent8}
                  </p>
                  <p className="course-components">
                    <b>{item3.questioncontent9}</b> {item3.answercontent9}
                  </p>
                  {/* <Accordion /> */}
                </div>
                ...
                <div className="course-requirements">
                  <h2 className="course-leranm-tittle">{item3.benefits}</h2>
